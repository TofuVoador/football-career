...
function App() {
  ...
  function GetMatch(team1, team2) {
    let base = Math.pow(team1.power, Math.log(450)) + Math.pow(team2.power, Math.log(450));
    let team1Power = Math.pow(team1.power, Math.log(450)) / base;
    let team2Power = Math.pow(team2.power, Math.log(450)) / base;

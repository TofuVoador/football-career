...
function App() {
  ...
  function GetMatch(team1, team2) {
    let base = Math.pow(team1.power, Math.log(600)) + Math.pow(team2.power, Math.log(600));
    let team1Power = Math.pow(team1.power, Math.log(600)) / base;
    let team2Power = Math.pow(team2.power, Math.log(600)) / base;
